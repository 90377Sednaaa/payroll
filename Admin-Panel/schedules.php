...
<body>
  <div
    ...
    <ul class="nav nav-pills flex-column mb-auto text-white">
      ...
      <li class="nav-item items">
        <a class="nav-link text-white active" href="../Admin-Panel/schedules.php"> Schedules</a>
      </li>
      <li class="nav-item items">
  ...
  <div class="container">
    <h1 class="mb-5"><strong>Schedules</strong></h1>
  </div>
  <div class="container">
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-schedules">Add Schedule</button>
